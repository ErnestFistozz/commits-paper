...
for oss_org in open_source_communities:
    with open(rf'C:\Users\Public\Documents\commits-paper\{oss_org}RepoNamesOnly.csv', 'a+', encoding='utf-8',newline='') as f:
...
for oss_org in open_source_communities:
    with open(rf'C:\Users\Public\Documents\commits-paper\{oss_org}_total_detail_repos.csv', 'a+', encoding='utf-8', newline='') as file:
